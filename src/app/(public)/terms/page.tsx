  ...
  const sections = [
    {
      ...
      content: "Users must be at least 18 years old to create an account. Sellers must provide a valid Drug License and Trade License. MedQuix reserves the right to reject any pharmacy registration that does not meet local health authority standards."
    },
    {
      id: "orders",
      icon: <ShoppingBag className="h-5 w-5" />,
      title: "Orders & Pricing",
      content: "All prices are listed in BDT and include applicable taxes unless stated otherwise. While we strive for accuracy, MedQuix is not responsible for pricing errors set by individual Sellers. Orders are confirmed only after Seller acceptance."
    },
    {
      id: "medicine",
      icon: <AlertTriangle className="h-5 w-5" />,
      title: "OTC Medicine Policy",
      content: "MedQuix only facilitates the sale of Over-The-Counter (OTC) medicines. We strictly prohibit the sale of prescription-only narcotics or regulated substances. Users agree to consult a doctor before consuming any medication."
    },
    {
      id: "returns",
      ...
      <section className="relative py-20 bg-slate-50 dark:bg-slate-900/50 border-b overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <p className="max-w-2xl mx-auto text-slate-600 dark:text-slate-400 text-lg">
            Please read these terms carefully before using the MedQuix platform. By accessing our services, you agree to be bound by these legal guidelines.
          </p>
        </div>
      </section>
          ...
          <main className="lg:col-span-9 space-y-16">
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                Welcome to MedQuix. These Terms and Conditions govern your use of our website and mobile application. We operate as a marketplace connecting licensed pharmacies (Sellers) with individual buyers (Customers).
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                MedQuix reserves the right to suspend or terminate accounts that violate these terms, specifically targeting Sellers who provide low-quality items or Customers who engage in fraudulent Cash-on-Delivery cancellations.
              </p>
            </div>
          </main>
